            ...
            <tr class="<?= "$file->operation $trClass" ?>">
                ...
                <td class="check">
                    ...
                    if ($file->operation === CodeFile::OP_SKIP) {
                        ...
                        // не отмечать галочками чекбокс для _search и _view
                        if(strpos($file->path,'_search.php')>10 || strpos($file->path,'view.php')>10){
                            echo Html::checkBox("answers[{$file->id}]", false);
                        }else {
                            //echo '&nbsp; ' . $file->path;
