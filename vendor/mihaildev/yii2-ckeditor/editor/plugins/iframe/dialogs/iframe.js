...
(function(){
	...
	var e={
		...
		allowfullscreen:{"true":"1","false":"0"}
	};
CKEDITOR.dialog.add("iframe",function(b){
	var f=b.lang.iframe,a=b.lang.common,e=b.plugins.dialogadvtab;
		return{
			...
			contents:[{
				id:"info",
				label:a.generalTab,accessKey:"I",
				elements:[{
					...
					type:"hbox",children:[{
						...
						style:"width:100%",
						labelLayout:"vertical",						
						label:a.align,setup:function(a,b){
							c.apply(this,arguments);
							if(b){var d=b.getAttribute("align");
						...
						children:[{
							...
							label:"Отображать во весь экран",
							setup:c,
							commit:d,
							"default":"true"
						}]},
