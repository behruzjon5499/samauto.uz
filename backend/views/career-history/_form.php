...
<div class="vacancy-form">
    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
                ...
                <?= $form->field($model, 'descr_ru')->textInput(['maxlength' => true]) ?>
            ...
            <div class="tab-pane" id="tab_2">
                ...
                <?= $form->field($model, 'descr_uz')->textInput(['maxlength' => true]) ?>
    ...
    <?php echo $form->field($model, 'image')->widget(FileInput::classname(), [
        ...
        'pluginOptions' => [
            ...
            'initialPreview' => [
                $model->preview_img ? '<img src="/uploads/career/history/' . $model->preview_img . '" width="200">': '<img src="/uploads/career/history/no-image.png" width="200">',
            ],
            'showRemove' => false,
            'showUpload' => false,
        ]
