...
?>
<a href="/admin/categories/create" class="btn btn-success">+ Добавить категорию для Локализации</a>
<div class="categories-form">
    ...
    $categories = \common\models\Categories::find()->where(['parent_id'=>0])->orderBy('parent_id DESC')->all(); // ; // только корневые

    //echo $model->cat_id; exit;
    ?>
    <label>Категории</label>
    <select class="form-control" name="Categories[parent_id]" id="select-category">
        <?php /*<option value="0" data-item="main" <?=$model->id == 0 ? 'selected' : '' ?>>Корневая</option> */ ?>
