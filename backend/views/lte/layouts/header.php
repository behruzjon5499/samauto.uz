...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">SamAuto</span><span class="logo-lg">' . $_SERVER['SERVER_NAME'] /*Yii::$app->name*/ . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <?php
            // сообщения
           /* if(!$messages = \common\models\ContactsMsg::find()->where(['status'=>'0'])->orderBy('date DESC')->limit(10)->all()){
                $messages = [];
            }*/
            $msg_count = 0;// count($messages);
        ?>
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="/admin/contacts-msg/update?id=<?=$message->id?>">
                                        <div class="pull-left">
                        ...
                        <?php } ?>
                        <li class="footer"><a href="/admin/contacts-msg">Все сообщения</a></li>
                        <?php } ?>
                    </ul>
                </li>
               <?php /*
