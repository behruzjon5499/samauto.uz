...
$this->title = 'Загрузка файла сертификата для дилерской сети';
...
<div class="">
    ...
    <button class="btn btn-success img_file" data-file="diller_sert">Загрузить файл</button>
    <div id="image-preview" style="display:none">
        <input type="file" name="Pages[tmp_file_diller_sert]" id="diller_sert" class="file">
    </div>

    <div id="box_diller_sert" class="container-file"  style="display: <?=  @$data['file_diller_sert'] != '' ? 'block': 'none' ?>">
        <img width="150px" src="/uploads/file.png">
        <button class="btn btn-danger remove-file" data-id="3">Удалить файл</button>
    </div>
