...
$this->title = 'Сервис - вопросы и ответы';
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <img width="300px" id="img_preview" class="thumb" src="<?= is_file($_SERVER['DOCUMENT_ROOT'] .'/frontend/web/uploads/services/faq.jpg') ? '/uploads/services/faq.jpg' : '' ?>" alt="">
        </div>
    ...
    <input type="hidden" name="Pages[page]" value="services-faq">
