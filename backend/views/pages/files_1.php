...
$this->title = 'Загрузка файла с прайсом';
...
<div class="">
    ...
    <div id="image-preview" style="display:none">
        <input type="file" name="Pages[tmp_file_price]" id="price" class="file">
    </div>

    <div id="box_price" class="container-file"  style="display: <?=  @$data['file_price'] != '' ? 'block': 'none' ?>">
