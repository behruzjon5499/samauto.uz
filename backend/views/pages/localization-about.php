...
$this->title = 'О локализации';
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <img width="300px" id="img_preview" class="thumb" src="<?= is_file($_SERVER['DOCUMENT_ROOT'] .'/frontend/web/uploads/products/loc-about.jpg') ? '/uploads/products/loc-about.jpg' : '' ?>" alt="">
        </div>

    </div>

    <input type="hidden" name="Pages[page]" value="localization-about">
