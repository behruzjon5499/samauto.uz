            ...
            <div class="tab-content">
                    ...
                    <div class="group">
                        <div class="panel box">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                <div class="box-body">
                                    <label>Модель</label>
                                    <input type="text" name="complect[engine_model]" class="form-control" value="<?=@$op['complect']['engine_model']?>"><br>
                                    <label>Объем, см<sup>3</sup></label>
                                    <input type="text" name="complect[engine_volume]" class="form-control" value="<?=@$op['complect']['engine_volume']?>"><br>
                                    ...
                                    */ ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="complect[power-rotate]" class="form-control" value="<?=@$op['complect']['power-rotate']?>"><br>
                                        </div>
                                    </div>
                                    ...
                                    <select name="complect[cilinders]" class="form-control">
                                        <option value="0" <?=$op['complect']['cilinders']=='0'?'selected':''?>>3</option>
                                        <option value="1" <?=$op['complect']['cilinders']=='1'?'selected':''?>>4</option>
                                        <option value="2" <?=$op['complect']['cilinders']=='2'?'selected':''?>>6</option>
                                        <option value="3" <?=$op['complect']['cilinders']=='3'?'selected':''?>>8</option>
                                    </select>
                                    <br>
                                    <label>Тип</label>
                                    <select name="complect[type]" class="form-control">
                                        <option value="0" <?=$op['complect']['type']=='0'?'selected':''?>>Рядный</option>
                                        <option value="1" <?=$op['complect']['type']=='1'?'selected':''?>>V-образный</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapse2" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                <div class="box-body">
                                    ...
                                    <select name="complect[drive]" class="form-control">
                                        <option value="0" <?=$op['complect']['drive']=='0'?'selected':''?>>Передний</option>
                                        <option value="1" <?=$op['complect']['drive']=='1'?'selected':''?>>Задний</option>
                                        <option value="2" <?=$op['complect']['drive']=='2'?'selected':''?>>Оба</option>
                                    </select>
                                    <br>
                                    <label>Коробка передач</label>
                                    <select name="complect[gearbox]" class="form-control">
                                        <option value="0" <?=$op['complect']['gearbox']=='0'?'selected':''?>>Механическая</option>
                                        <option value="1" <?=$op['complect']['gearbox']=='1'?'selected':''?>>Автоматическая</option>
                                    </select>
                                    <br>
                                    <label>Количество передач</label>
                                    <input type="text" name="complect[gearbox_count]" class="form-control" value="<?=@$op['complect']['gearbox_count']?>">
                                    </br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select name="complect[gearstop-front]" class="form-control">
                                                <option value="0" <?=@$op['complect']['gearstop-front']=='0'?'selected':''?>>Дисковые</option>
                                                <option value="1" <?=@$op['complect']['gearstop-front']=='1'?'selected':''?>>Барабанные</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Задняя ось</label>
                                            <select name="complect[gearstop-back]" class="form-control">
                                                <option value="0" <?=@$op['complect']['gearstop-back']=='0'?'selected':''?>>Дисковые</option>
                                                <option value="1" <?=@$op['complect']['gearstop-back']=='1'?'selected':''?>>Барабанные</option>
                                            </select>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label>Передняя ось</label>
                                            <input type="text" name="complect[base_front]" class="form-control" value="<?=@$op['complect']['base_front']?>">
                                        </div>
                                        <div class="col-md-6">
                                            <label>Задняя ось</label>
                                            <input type="text" name="complect[base_back]" class="form-control" value="<?=@$op['complect']['base_back']?>">
                                        </div>
                                    </div>
                        ...
                        <div class="panel box">
                            ...
                            <div id="collapse5" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                <div class="box-body">
                                    ...
                                    <input type="text" name="complect[width]" class="form-control" value="<?=@$op['complect']['width']?>"><br>
                                    <label>Длина, мм</label>
                                    <input type="text" name="complect[length]" class="form-control" value="<?=@$op['complect']['length']?>"><br>
                                    <label>Высота, мм</label>
                                    <input type="text" name="complect[height]" class="form-control" value="<?=@$op['complect']['height']?>"><br>
                                    <label>Колесная база, мм</label>
                                    <input type="text" name="complect[base]" class="form-control" value="<?=@$op['complect']['base']?>"><br>
                                    <label>Минимальный радиус разворота, мм</label>
                                    <input type="text" name="complect[radius]" class="form-control" value="<?=@$op['complect']['radius']?>"><br>
                                </div>
                            </div>
                        </div>
                        <div class="panel box">
                            ...
                            <div id="collapse1" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                <div class="box-body">
                                    <label>Ширина, мм</label>
                                    <input type="text" name="complect[width_trucks]" class="form-control" value="<?=@$op['complect']['width_trucks']?>"><br>
                                    <label>Длина, мм</label>
                                    <input type="text" name="complect[length_trucks]" class="form-control" value="<?=@$op['complect']['length_trucks']?>"><br>
                                    <label>Высота, мм</label>
                                    <input type="text" name="complect[height_trucks]" class="form-control" value="<?=@$op['complect']['height_trucks']?>"><br>
                                </div>
                            </div>
                        </div>
                        <div class="panel box">
                            ...
                            <div id="collapse6" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                <div class="box-body">
                                    ...
                                    <select name="complect[fuel-type]" class="form-control">
                                        <option value="0" <?=@$op['complect']['fuel-type']=='0'?'selected':''?>>Бензин</option>
                                        <option value="1" <?=@$op['complect']['fuel-type']=='1'?'selected':''?>>Дизель</option>
                                        <option value="2" <?=@$op['complect']['fuel-type']=='2'?'selected':''?>>Газ</option>
                                    </select>
                                    <br>
                                    <label>Тип и марка</label>
                                    <input type="text" name="complect[fuel-model]" class="form-control" value="<?=@$op['complect']['fuel-model']?>"><br>
                                    <label>Объем топливного бака</label>
                                    <input type="text" name="complect[fuel-size]" class="form-control" value="<?=@$op['complect']['fuel-size']?>"><br>
                                </div>
                            </div>
                        </div>
                        <div class="panel box">
                            ...
                            <div id="collapse3" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                <div class="box-body">
                                    ...
                                    <input type="text" name="complect[expense_city]" class="form-control" value="<?=@$op['complect']['expense_city']?>"><br>
                                    <label>Загородный режим, л</label>
                                    <input type="text" name="complect[expence_out]" class="form-control" value="<?=@$op['complect']['expence_out']?>"><br>
                                    <label>Смешанный режим, л</label>
                                    <input type="text" name="complect[expense_both]" class="form-control" value="<?=@$op['complect']['expense_both']?>"><br>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel box">
                            ...
                            <div id="collapse4" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                <div class="box-body">
                                    ...
                                    <input type="text" name="complect[accel_time]" class="form-control" value="<?=@$op['complect']['accel_time']?>"><br>
                                    <label>Максимальная скорость, км/час</label>
                                    <input type="text" name="complect[speed]" class="form-control" value="<?=@$op['complect']['speed']?>"><br>
                                    <label>Количество дверей</label>
                                    <input type="text" name="complect[doors]" class="form-control" value="<?=@$op['complect']['doors']?>"><br>
                                    <label>Количество пассажиров</label>
                                    <input type="text" name="complect[count]" class="form-control" value="<?=@$op['complect']['count']?>"><br>
                                    <label>Количество мест для сидения</label>
                                    <input type="text" name="complect[count_branch]" class="form-control" value="<?=@$op['complect']['count_branch']?>"><br>
                                    <label>Объем багажного отделения, л</label>
                                    <input type="text" name="complect[volume]" class="form-control" value="<?=@$op['complect']['volume']?>"><br>
                                    <label>Cнаряженная масса, кг</label>
                                    <input type="text" name="complect[mass]" class="form-control" value="<?=@$op['complect']['mass']?>"><br>
                ...
                <div class="tab-pane" id="tab_4">
                    ...
                    <div id="image-preview" style="display:none">
                        <input type="file" name="Transport[tmp_image]" id="img_preview" class="image" accept="image/*">
                    </div>

                    <img width="266px" id="img_preview" class="thumb" src="<?=$model->isNewRecord  ? '' : '/uploads/transport/'.$model->id .'/thumb/' . $model->image . '?v=' . rand(1000000,9999999) ?>" alt="">
                ...
                <div class="tab-pane" id="tab_5">
                    ...
                    <div id="image-preview" style="display:none">
                        <input type="file" id="img_preview_gallery" name="Transport[tmp_gallery_images][]"  class="image" accept="image/*" multiple />
                    </div>
                    ...
                    <div id="preview_gallery">
                        ...
                        if( $gallery ){
                            ...
                            foreach( $gallery as $gal ){
                                ...
                                ?>
                                <span class="pip_old">
                                        <img class="imageThumb" src="/uploads/transport/<?=$model->id.'/gallery/thumb/'.$gal->image.'?v=' . rand(1000000,9999999) ?>"><br>
