...
class CareerInfoController extends Controller
{
    ...
    {
        $searchModel = new CareerInfoSearch();
    ...
    {
        $model = new CareerInfo();

        if (Yii::$app->request->isPost && $model->load(Yii::$app->request->post())) {
            if (!empty($_FILES['CareerInfo']['name']['image'])) {
                $model->image = $_POST['CareerInfo']['image'];
     ...
     * @param integer $id
     * @return CareerInfo the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CareerInfo::findOne($id)) !== null) {
            return $model;
        } else {
