function setHotspotReel() {
    ...
    if (getGrade() === "ls") { 
        hotspot = {
            ...
            //
            "hotspot_05_01": setHotspot(10, 748, 293, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_02": setHotspot(11, 619, 327, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_03": setHotspot(12, 469, 325, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_04": setHotspot(13, 325, 306, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_05": setHotspot(14, 220, 293, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_06": setHotspot(15, 144, 275, 'imagefile0=Rear_Combi_LHD', ''),
            //
            "hotspot_06_02": setHotspot(10, 854, 345, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_03": setHotspot(11, 781, 384, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_04": setHotspot(12, 663, 392, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_05": setHotspot(13, 519, 384, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_06": setHotspot(14, 384, 372, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_07": setHotspot(15, 264, 357, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_08": setHotspot(16, 178, 340, 'imagefile0=Rear_bumper_LHD', ''),
            //
    ...
    if (getCurrentModel() === "GEXP_LHD_EXTENDED_RBD") { //getCurrentModel() === "GEXP_LHD_CREW_RBA" //g
        hotspot = {
            ...
            "hotspot_05_01": setHotspot(10, 748, 293, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_02": setHotspot(11, 619, 327, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_03": setHotspot(12, 466, 325, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_04": setHotspot(13, 325, 306, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_05": setHotspot(14, 220, 293, 'imagefile0=Rear_Combi_LHD', ''),
            "hotspot_05_06": setHotspot(15, 144, 275, 'imagefile0=Rear_Combi_LHD', ''),

            "hotspot_06_02": setHotspot(10, 856, 347, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_03": setHotspot(11, 783, 380, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_04": setHotspot(12, 661, 393, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_05": setHotspot(13, 522, 384, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_06": setHotspot(14, 381, 372, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_07": setHotspot(15, 266, 353, 'imagefile0=Rear_bumper_LHD', ''),
            "hotspot_06_08": setHotspot(16, 134, 641, 'imagefile0=Rear_bumper_LHD', ''),

            "hotspot_10_01": setHotspot(3, 582, 275, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_02": setHotspot(4, 566, 276, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_03": setHotspot(5, 543, 280, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_04": setHotspot(6, 518, 280, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_05": setHotspot(7, 486, 280, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_06": setHotspot(8, 451, 280, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_07": setHotspot(9, 418, 280, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_08": setHotspot(10, 387, 280, 'imagefile0=SAP_LHD', ''),
            "hotspot_10_09": setHotspot(11, 358, 280, 'imagefile0=SAP_LHD', ''),

            "hotspot_11_01": setHotspot(14, 587, 346, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_02": setHotspot(15, 554, 354, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_03": setHotspot(16, 516, 360, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_04": setHotspot(17, 483, 359, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_05": setHotspot(18, 443, 358, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_06": setHotspot(19, 410, 353, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_07": setHotspot(20, 374, 344, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_08": setHotspot(21, 354, 336, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_09": setHotspot(22, 332, 335, 'imagefile0=Side_Step_Extended', ''),
            "hotspot_11_10": setHotspot(23, 323, 331, 'imagefile0=Side_Step_Extended', ''),
