...
function loadReel(url) {
    ...
    $img.reel({
        ...
        if (!isFirst) { 
            if (getCurrentModel() == "GEXP_LHD_REGULAR_RBA")  { 
...
$(function () {
    ...
    $('#ctrl-cab-extended, #ctrl-cab-single, #ctrl-cab-crew, #btn-grade-starndard, #btn-grade-ls').click(function () {
        ...
        $ctrlColor.fadeOut(500, function () {
            ...
            if (++counter === 1) {
                ...
                if ((getCurrentModel() === "GEXP_LHD_CREW_RBD")) {
                ...
                } else if (getCurrentModel() === "GEXP_LHD_CREW_RBA") {
                    ...
                    if (getCurrentModel() == "GEXP_LHD_EXTENDED_RBD") {
                        $('#text-detail').addClass('text-detail-extend'); 
                        
                    } else if (getCurrentModel() == "GEXP_LHD_REGULAR_RBA") {
                ...
                if ((getCurrentModel() === "GEXP_LHD_CREW_RBA") || (getCurrentModel() === "GEXP_LHD_CREW_RBD") || (getCurrentModel() === "GEXP_LHD_EXTENDED_RBD")) {   
...
function isHotspot() {
    var status = false;
    var $textHotspot = $('#text-hotspot');
    if (((getCurrentModel() === "GEXP_LHD_EXTENDED_RBD") || getCurrentModel() === "GEXP_LHD_REGULAR_RBA") ||
        (getCurrentModel() === "GEXP_LHD_REGULAR_RBA")) {
        status = true;
    }
...
$(window).load(function () {
    ...
    //        "images/hotspot/exterior/05_Rear_Combi_LHD.jpg",
