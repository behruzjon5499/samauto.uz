...
class SiteController extends Controller
{
    ...
    public function beforeAction($action)
   {
    ...
    {
        if( ! $leaderships = CompanyUsers::find()->with('workers')->where(['status'=>1,'type'=>1])->limit(3)->all()) {
            $leaderships = false;
        }
    ...
    public function actionSearch()
    {
        ...
        $queryActions = Actions::find()->where(['status' => 1]);
        ...
        $queryDillersOffics = DillersOffice::find()->where(['status' => 1]);
        $queryDillersServices = DillersServices::find()->where(['status' => 1]);
        ...
        if ( count($q) > 0) {
           ...
           $results[] = [
            ...
            $results[] = [
                'title'=>'История',
                'items' => $queryHistory->andWhere($or_query)->all(),
                'link_type' => 'history',
                'field' => 'title_' . $this->lang,
            ]
            ;
