...
?>
    ...
    <div class="fullpage_header flex_row_beet_cen <?= $is_main ? 'land_header' : 'page_header bgWhite' ?>" style="<?= Yii::$app->controller->action->id == 'contacts' ? 'background-color: #fff' : '' ?>">
        ...
        <div class="rightBox flex_row_end_cen">
            <div class="search"> <!-- style="margin-right: 0px;" если один-->
                <form action="">
                    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="2.3098mm" height="2.28mm" version="1.1"
                         style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
                         viewBox="0 0 17.24 17.02"
                         xmlns:xlink="http://www.w3.org/1999/xlink"> <!-- margin-right:0px !important; если один-->
                         <g>
                             <metadata/>
                             <g>
            ...
            <div class="lang lang-mob-show">
                <a href="#" class="under-hover preload"><?=$lang ?></a>
                <div class="drop">
                    <div>
                       <?php if($lang!='ru'){ ?>
                            <a href="/lang/ru" class="under-hover preload">RU</a>
