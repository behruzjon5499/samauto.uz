...
$this->title = LangHelper::t('Информация', 'Ma\'lumotlar', 'Information' );
    ...
    <div class="small_container">
        ...
        <div class="boxes" style="flex-wrap: wrap" data-aos="fade-up" data-aos-delay="200">
            ...
            foreach ($informations as $item):?>
                ...
                <div class="col-6">
                    <a href="information?id=<?= $item->id?>" class="item">
                        <div class="<?php
                        if (++$i == 2) {
                            $isLeft = !$isLeft;
                            $i = 0;
                        ...
                        ?>">
                            <?php if ($isLeft) echo '<div class="num"></div><span>'. $item->$title .'</span>'; else {echo Html::img($item->preview_img ? '/uploads/career/info/'. $item->preview_img : '/uploads/career/info/'. $noImage);}?>
