...
$this->title =LangHelper::t("КОНТАКТЫ", "ALOQA", "CONTACTS");
...
?>
            ...
            <div class="small_container section-gap">
                <div class="info-box scrollYAll">
                    <div class="box">
                        ...
                        <a onclick="mapPanTo(<?=@$page['sam_lat'] .','. @$page['sam_lon'] ?>); return false;" class="address active"><?=@$page['sam_address_'.$lang]?></a>
                        <div class="icon-text">
                            ...
                            <p><?=@$page['sam_phone1_'.$lang]?> <br> <?=@$page['sam_phone2_'.$lang]?></p>
                        </div>
                        <div class="icon-text">
                    ...
                    <div class="box">
                        ...
                        <a onclick="mapPanTo(<?=@$page['tash_lat'] .','. @$page['tash_lon'] ?>); return false;" class="address"><?=@$page['tash_address_'.$lang]?></a>
                        <div class="icon-text">
                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="1.9662mm" height="1.9662mm" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
                                 viewBox="0 0 3.3 3.3"
                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <p><?=@$page['tash_phone1_'.$lang]?> <br> <?=@$page['tash_phone2_'.$lang]?></p>
                        </div>
                        <div class="icon-text">
                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="1.944mm" height="1.9439mm" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
                                 viewBox="0 0 3.23 3.23"
    ...
    <script>
        function initMap() {
            var uluru = {lat: <?=@$page['sam_lat'] ?>, lng: <?=@$page['sam_lon'] ?>};
            var uluru2 = {lat: <?=@$page['tash_lat'] ?>, lng: <?=@$page['tash_lon'] ?>};
