...
class CategoriesSearch extends Categories
{
    ...
    {
        $query = Categories::find()->with('parent');///->where(['parent_id'=>0]); // только корневые категории
    ...
    public function searchSubCategories($params)
    {
        ...
        //print_r($params); exit;
        $query = Categories::find()->where(['parent_id'=>$params['id']]); // только корневые категории
