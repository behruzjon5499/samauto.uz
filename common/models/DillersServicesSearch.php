...
/**
 * DillersServicesSearch represents the model behind the search form about `common\models\DillersServices`.
 */
class DillersServicesSearch extends DillersServices
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'office_id', 'diller_id'], 'integer'],
            [['image','status', 'title_ru', 'title_uz', 'title_en', 'username_ru', 'username_uz', 'username_en', 'doljnost_ru', 'doljnost_uz', 'doljnost_en', 'phone', 'text_ru', 'text_uz', 'text_en', 'phones', 'fax', 'email', 'site', 'lat', 'lon'], 'safe'],
        ];
    }
    ...
    {
        $query = DillersServices::find()->where(['diller_id'=>$params['diller_id']]);
